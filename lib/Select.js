	...
	filterOptions: function filterOptions(options, excludeOptions) {
		...
		if (this.props.filterOptions) {
			var _ret = (function () {
				...
				var filterOptions = typeof _this6.props.filterOptions === 'function' ? _this6.props.filterOptions : _utilsDefaultFilterOptions2['default'];
				...
				options.forEach(function (option) {
					if (_this6.isGroup(option)) {
						...
						filteredOptions = filteredOptions.concat(filterOptions([option], filterValue, excludeOptions, {
							filterOption: _this6.props.filterOption,
							ignoreAccents: _this6.props.ignoreAccents,
							ignoreCase: _this6.props.ignoreCase,
							labelKey: _this6.props.labelKey,
							matchPos: _this6.props.matchPos,
							matchProp: _this6.props.matchProp,
