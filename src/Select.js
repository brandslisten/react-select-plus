...
const Select = React.createClass({
  ...
  propTypes: {
	...
	multiText: React.PropTypes.bool,          	// show selected values only as text, defaults to false
	...
	removeOptions: React.PropTypes.bool,   		// remove options on select in multiple dropdown,
  ...
  componentDidUpdate (prevProps, prevState) {
	...
	let multiScrollDisable = this.props.multi && !this.props.removeOptions;
  ...
  renderValue (valueArray, isOpen) {
	...
	if (this.props.multi) {
	  if (this.props.multiText) {
		let value = valueArray.map(i => stringifyValue(i[this.props.valueKey])).join(', ');
		return (
	...
	if (options && options.length) {
	  if (this.props.menuRenderer) {
		...
		return options.map((option, i) => {
		  ...
		  ref={optionRef}
		  showCheckedIcon={this.props.multi && !this.props.removeOptions}
		>
		  {renderLabel(option)}
		</Option>
		);
  ...
  renderOuter (options, valueArray, focusedOption) {
	...
	return (
		<Dropdown>
		<div ref="menuContainer" className="Select-menu-outer bal" style={this.props.menuContainerStyle}>
